...
export default function HostNotifications() {
  ...
  const handleMarkAsRead = async (e: React.MouseEvent, id: string) => {
    e.stopPropagation(); // Avoid triggering navigation if item has a link
    try {
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm">
            Keep track of booking requests, payments, and system updates.
          </p>
        </div>
        {unreadCount > 0 && (
          <Button
            ...
            variant="outline"
            className="rounded-xl h-10 gap-2 border-primary/20 hover:bg-primary/5 hover:text-primary transition-colors shrink-0"
          >
      ...
      <div className="space-y-3">
        {isLoading ? (
          ...
          <Card className="border-0 shadow-sm bg-card/60 backdrop-blur-md py-16 text-center rounded-2xl">
                ...
                return (
                  ...
                  >
                    <Card
                      ...
                      className={`group border-0 shadow-sm hover:shadow-md transition-all duration-300 rounded-2xl overflow-hidden cursor-pointer ${
                        n.is_read
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex flex-col sm:flex-row sm:items-baseline justify-between gap-1">
                            <h4 className={`text-sm font-semibold truncate ${
                              n.is_read ? 'text-foreground' : 'text-primary-text'
                            }`}>
                              {n.title}
                            </h4>
