        ...
        <TabsContent value="security" className="mt-6 space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              {twoFAStatus === 'idle' && (
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-lg border border-border bg-secondary/30">
                  <div>
              ...
              {twoFAStatus === 'enabled' && !showRecovery && (
                <div className="space-y-4">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-lg border border-green-200 bg-green-50 dark:bg-green-950/20 dark:border-green-800">
                    ...
                    <Badge className="bg-green-600 hover:bg-green-600 text-white w-fit">Active</Badge>
                  </div>
                  <Button
                    variant="outline"
                  ...
                  >
                    {isTwoFALoading ? <Loader2 className="h-4 w-4 mr-2 animate-spin" /> : <Trash2 className="h-4 w-4 mr-2" />}
                    Disable 2FA
                  </Button>
                </div>
              )}

              {twoFAStatus === 'enrolling' && twoFAData && (
                  ...
                  <div className="p-4 rounded-lg border border-border bg-secondary/20">
                    ...
                    <div className="flex justify-center mb-4">
                      <div
                        ...
                        dangerouslySetInnerHTML={{ __html: twoFAData.qrCode }}
                      />
                    </div>
                    ...
                    <div className="flex items-center gap-2 justify-center">
                      <code className="text-xs bg-muted px-3 py-1.5 rounded font-mono break-all text-center">
                        {twoFAData.secret}
                      </code>
                      <Button variant="ghost" size="icon" className="shrink-0" onClick={copySecret}>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-2">
                      <Button
                        ...
                        className="flex-1"
                      >
                        {isTwoFALoading ? <Loader2 className="h-4 w-4 mr-2 animate-spin" /> : <CheckCircle className="h-4 w-4 mr-2" />}
                        Verify & Enable
                      </Button>
                      <Button
                        variant="outline"
                        onClick={() => { setTwoFAStatus('idle'); setTwoFAData(null); setTwoFACode(''); }}
                      >
                        Cancel
                      </Button>
                    </div>
                ...
                <div className="space-y-3 p-4 rounded-lg border border-amber-200 bg-amber-50 dark:bg-amber-950/20 dark:border-amber-800">
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-3">
                    {recoveryCodes.map((code) => (
                      <code key={code} className="text-xs font-mono bg-white dark:bg-black/20 px-2 py-1 rounded border border-amber-200 dark:border-amber-800 text-center">
                        {code}
                      </code>
                    ))}
                  </div>
              ...
              {twoFAStatus === 'idle' && (
                <Button
                  ...
                  variant="outline"
                >
                  {isTwoFALoading ? <Loader2 className="h-4 w-4 mr-2 animate-spin" /> : <QrCode className="h-4 w-4 mr-2" />}
