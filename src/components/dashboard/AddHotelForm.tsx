...
import { useCreateHotel } from '@/hooks/useListings';
...
const propertyTypes = ['Hotel', 'Boutique Hotel', 'Business Hotel', 'Suite Hotel', 'Heritage Hotel'];
...
const STANDARD_AMENITIES = [
  ...
  { key: 'dedicatedWorkspace' as const, label: 'Business Center' },
...
export function AddHotelForm() {
  ...
  const [form, setForm] = useState<FormState>({
    ...
    latitude: '', longitude: '', property_type: 'Hotel',
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="icon" onClick={() => navigate('/host/hotels')}>
          <ArrowLeft className="h-5 w-5" />
        </Button>
        <div>
          <h1 className="text-2xl font-bold text-foreground">Add New Hotel</h1>
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Input id="title" value={form.title} onChange={e => setF('title', e.target.value)} placeholder="e.g. Grand Palace Hotel" />
              </div>
              <div>
              ...
              <div>
                ...
                <Textarea id="description" value={form.description} onChange={e => setF('description', e.target.value)} placeholder="Describe your hotel in detail..." rows={5} />
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Input id="location" value={form.location} onChange={e => setF('location', e.target.value)} placeholder="e.g. MG Road, Bengaluru" />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="state">State</Label>
                  <Input id="state" value={form.state} onChange={e => setF('state', e.target.value)} placeholder="e.g. Karnataka" />
                </div>
                <div>
                  <Label htmlFor="city">City</Label>
                  <Input id="city" value={form.city} onChange={e => setF('city', e.target.value)} placeholder="e.g. Bengaluru" />
                </div>
              </div>
              <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input id="lat" type="number" step="any" value={form.latitude} onChange={e => setF('latitude', e.target.value)} placeholder="12.9716" />
                </div>
                <div>
                  <Label htmlFor="lng">Longitude</Label>
                  <Input id="lng" type="number" step="any" value={form.longitude} onChange={e => setF('longitude', e.target.value)} placeholder="77.5946" />
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-2 md:grid-cols-3 gap-4">
              ...
              <div>
                <Label htmlFor="bedrooms">Rooms / Suites</Label>
                <Input id="bedrooms" type="number" min={0} value={form.bedrooms} onChange={e => setF('bedrooms', e.target.value)} placeholder="50" />
              </div>
              <div>
                <Label htmlFor="beds">Beds</Label>
                <Input id="beds" type="number" min={0} value={form.beds} onChange={e => setF('beds', e.target.value)} placeholder="80" />
              </div>
              <div>
                <Label htmlFor="bathrooms">Bathrooms</Label>
                <Input id="bathrooms" type="number" min={0} value={form.bathrooms} onChange={e => setF('bathrooms', e.target.value)} placeholder="50" />
              </div>
              <div className="md:col-span-2">
                <Label htmlFor="propSize">Property Size</Label>
                <Input id="propSize" value={form.propertySize} onChange={e => setF('propertySize', e.target.value)} placeholder="e.g. 2 acres" />
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <ListingImageUploader
                ...
                label="Click to upload hotel photos"
                showFeaturedBadge
              />
            </CardContent>
          </Card>
          ...
          {/* Room Photos */}
          <Card>
            <CardHeader><CardTitle>Room / Suite Photos</CardTitle></CardHeader>
            <CardContent>
              <ListingImageUploader
              ...
              <div>
                ...
                <div className="flex gap-2 mt-1">
                  <Input
                    ...
                    placeholder="e.g. Conference hall, Valet parking, Rooftop lounge"
                  />
                ...
                <div key={i} className="p-4 rounded-lg border border-border space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <Input value={b.description} onChange={e => updateBedroom(i, 'description', e.target.value)} placeholder="e.g. King room with workspace" className="h-8 text-sm" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div>
                      ...
                      <Input type="number" min={1} value={b.sizeSqFt} onChange={e => updateBedroom(i, 'sizeSqFt', e.target.value)} placeholder="e.g. 350" className="h-8 text-sm" />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <div className="flex gap-1 mt-1">
                        <Input
                          ...
                          placeholder="e.g. Mini-bar, Safety box"
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Textarea id="houseRules" value={form.houseRules} onChange={e => setF('houseRules', e.target.value)} placeholder="Quiet hours after 10 PM, ID card required at check-in..." rows={3} />
              </div>
              <div>
                <Label htmlFor="healthSafety">Health & Safety</Label>
                <Textarea id="healthSafety" value={form.healthSafety} onChange={e => setF('healthSafety', e.target.value)} placeholder="Fire exit plan, 24/7 security guard, CCTV in common areas..." rows={3} />
              </div>
            </CardContent>
          </Card>
              ...
              <div>
                ...
                <div className="flex gap-2 mt-1">
                  <Input
                    ...
                    placeholder="e.g. Grand Buffet (0.1 km)"
                    className="h-8 text-sm"
                    onKeyDown={e => {
                      if (e.key === 'Enter') {
                        e.preventDefault();
              ...
              <div>
                ...
                <div className="flex gap-2 mt-1">
                  <Input
                    ...
                    placeholder="e.g. City Museum (1 km)"
                    className="h-8 text-sm"
                    onKeyDown={e => {
                      if (e.key === 'Enter') {
                        e.preventDefault();
              ...
              <div>
                ...
                <div className="flex gap-2 mt-1">
                  <Input
                    ...
                    placeholder="e.g. Metro Station (0.3 km)"
                    className="h-8 text-sm"
                    onKeyDown={e => {
                      if (e.key === 'Enter') {
                        e.preventDefault();
              ...
              <div>
                ...
                <div className="flex gap-2 mt-1">
                  <Input
                    ...
                    placeholder="e.g. Fortis Hospital (2 km)"
                    className="h-8 text-sm"
                    onKeyDown={e => {
                      if (e.key === 'Enter') {
                        e.preventDefault();
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input id="hostName" value={form.hostName} onChange={e => setF('hostName', e.target.value)} placeholder="e.g. Hotel Management" />
                </div>
                <div>
              ...
              <div>
                ...
                <Textarea id="hostDescription" value={form.hostDescription} onChange={e => setF('hostDescription', e.target.value)} placeholder="Describe the hotel hospitality history..." rows={3} />
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="space-y-6">
              ...
              <div className="pt-2 border-t border-border">
                ...
                <div className="flex gap-2 mt-1">
                  <Input
                    ...
                    placeholder="e.g. Suite upgrade package"
                    className="h-8 text-sm"
                    onKeyDown={e => {
                      if (e.key === 'Enter') {
                        e.preventDefault();
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Input id="price" type="number" min={1} value={form.price_per_night} onChange={e => setF('price_per_night', e.target.value)} placeholder="4000" />
              </div>
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <Label htmlFor="originalPrice" className="text-xs">Original Price</Label>
                  <Input id="originalPrice" type="number" min={0} value={form.originalPrice} onChange={e => setF('originalPrice', e.target.value)} placeholder="5000" className="h-8 text-sm" />
                </div>
                <div>
                  <Label htmlFor="discountedPrice" className="text-xs">Discounted Price</Label>
                  <Input id="discountedPrice" type="number" min={0} value={form.discountedPrice} onChange={e => setF('discountedPrice', e.target.value)} placeholder="4000" className="h-8 text-sm" />
                </div>
              </div>
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <Label htmlFor="dailyPrice" className="text-xs">Daily Price</Label>
                  <Input id="dailyPrice" type="number" min={0} value={form.dailyPrice} onChange={e => setF('dailyPrice', e.target.value)} placeholder="4000" className="h-8 text-sm" />
                </div>
                <div>
                  <Label htmlFor="taxesAndFees" className="text-xs">Taxes & Fees</Label>
                  <Input id="taxesAndFees" type="number" min={0} value={form.taxesAndFees} onChange={e => setF('taxesAndFees', e.target.value)} placeholder="200" className="h-8 text-sm" />
                </div>
              </div>
              <div>
          ...
          <Button type="submit" className="w-full" disabled={createHotel.isPending}>
            <Save className="h-4 w-4 mr-2" />
            {createHotel.isPending ? 'Creating...' : 'Create Hotel Listing'}
          </Button>
        </div>
      </form>
    </motion.div>
